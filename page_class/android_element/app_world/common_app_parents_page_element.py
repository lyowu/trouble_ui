...
# 家长中心页元素管理
class ParentsPageElement:

    # 首页顶部菜单栏--家长中心入口
    @staticmethod
    def world_parents_access():
        world_parents_access = "com.sinyee.babybus.world:id/iv_search_icon"
        return AppFindElement.find_element_by_name(world_parents_access)
